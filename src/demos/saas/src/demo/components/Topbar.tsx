...
export const Topbar = () => {
  ...
  return (
    <header className="sticky top-0 z-40 flex h-14 items-center justify-between border-b border-slate-200 bg-white/95 px-4 backdrop-blur-xl sm:h-20 sm:px-6 lg:px-12">
      <div className="flex items-center gap-3 sm:gap-8">
        <div className="flex items-center gap-3">
          <span className="text-base font-bold tracking-tight text-slate-900 sm:text-2xl">
        ...
        <div className="hidden items-center gap-2 text-[10px] font-semibold uppercase tracking-widest text-slate-400 lg:flex">
          <Command size={14} />
          <span>Press <kbd className="rounded bg-slate-100 px-1 text-slate-600">Ctrl+K</kbd> to search</span>
        </div>
      </div>
        ...
        <button className="flex items-center gap-4 group">
          ...
          <div className="relative">
            <img
              ...
              className="h-9 w-9 sm:h-10 sm:w-10 rounded-full border border-slate-200 object-cover transition-all duration-300 group-hover:ring-2 group-hover:ring-indigo-200"
