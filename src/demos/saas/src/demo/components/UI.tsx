    ...
    >
      {(title || subtitle) && (
        <div className="flex items-end justify-between border-b border-slate-100 px-6 py-4">
          <div>
            {title && <h3 className="text-xl font-semibold leading-none text-slate-900">{title}</h3>}
...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const sizes = {
    ...
    md: "px-5 py-2 text-xs font-semibold uppercase tracking-widest",
    lg: "px-8 py-3 text-sm font-semibold uppercase tracking-widest",
    icon: "p-2"
  };
